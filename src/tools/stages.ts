...
export function registerStageTools(
  ...
  registerTool(server, config, {
    ...
    title: "Delete Stage",
    description:
      "Delete a stage by its UUID (cross-type). This action is irreversible.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
    ...
    handler: async (args) => {
      await client.stagesApi.stagesAllDestroy({
        stageUuid: args.stage_uuid as string,
      });
  ...
  registerTool(server, config, {
    ...
    description:
      "Create a new stage of a specific type. Pass type-specific fields in the config object.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: false,
  ...
  registerTool(server, config, {
    ...
    description:
      "Update an existing stage of a specific type. Pass type-specific fields in the config object.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
  ...
  registerTool(server, config, {
    ...
    description:
      "Delete a stage of a specific type by its UUID. This action is irreversible.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      single_use: z
        .boolean()
        .optional()
        .describe("Whether the invitation can only be used once"),
      flow: z
        .string()
        .optional()
        .describe("Flow slug to use for this invitation"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    description:
      "Update an existing invitation. Only provided fields are modified.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
    ...
    handler: async (args) => {
      const result =
        await client.stagesApi.stagesInvitationInvitationsPartialUpdate({
          inviteUuid: args.invite_uuid as string,
  ...
  registerTool(server, config, {
    ...
    description:
      "Delete an invitation by its UUID. This action is irreversible.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      type: z
        .string()
        .describe(
          "Prompt type (e.g., text, email, password, number, checkbox, radio-button-group, dropdown, etc.) (required)",
        ),
      required: z
        .boolean()
        .optional()
      ...
      placeholder_expression: z
        .boolean()
        .optional()
        .describe("Whether the placeholder is a Python expression"),
      initial_value_expression: z
        .boolean()
        .optional()
        .describe("Whether the initial value is a Python expression"),
    ...
    handler: async (args) => {
      const result = await client.stagesApi.stagesPromptPromptsCreate({
        promptRequest: {
          ...
          placeholderExpression: args.placeholder_expression as
            | boolean
            | undefined,
          initialValueExpression: args.initial_value_expression as
            | boolean
            | undefined,
  ...
  registerTool(server, config, {
    ...
    title: "Update Prompt",
    description:
      "Update an existing prompt field definition. Only provided fields are modified.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
  ...
  registerTool(server, config, {
    ...
    title: "Delete Prompt",
    description:
      "Delete a prompt field definition by its UUID. This action is irreversible.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
