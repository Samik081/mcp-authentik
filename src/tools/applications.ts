...
export function registerApplicationTools(
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      search: z
        .string()
        .optional()
        .describe("Search across application fields"),
      superuser_full_list: z
        .boolean()
        .optional()
        .describe("When true, return all apps regardless of policy"),
      for_user: z
        .number()
        .optional()
        .describe("Filter applications accessible by this user ID"),
      ordering: z
        .string()
        .optional()
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      policy_engine_mode: z
        ...
        .optional()
        .describe(
          'Policy engine mode: "all" (all policies must pass) or "any" (any policy must pass)',
        ),
      open_in_new_tab: z
        .boolean()
        .optional()
        .describe("Open launch URL in a new browser tab"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      slug: z
        .string()
        .describe("Application slug (required, used as identifier)"),
  ...
  registerTool(server, config, {
    ...
    handler: async (args) => {
      await client.coreApi.coreApplicationsDestroy({
        slug: args.slug as string,
      });
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      search: z
        .string()
        .optional()
        .describe("Search across entitlement fields"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    handler: async (args) => {
      const result =
        await client.coreApi.coreApplicationEntitlementsPartialUpdate({
          pbmUuid: args.pbm_uuid as string,
