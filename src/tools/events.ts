...
export function registerEventTools(
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      action: z
        .string()
        .describe('Event action (e.g. "custom_", "login", "model_created")'),
      app: z
        .string()
      ...
      expires: z
        .string()
        .optional()
        .describe("Expiration date-time (ISO 8601)"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      history_days: z
        .number()
        .optional()
        .describe("Number of days to include in history"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      severity: z
        .string()
        .optional()
        .describe("Filter by severity (alert, notice, warning)"),
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      transports: z
        .array(z.string())
        .optional()
        .describe("Transport UUIDs to use for notifications"),
      severity: z
        .string()
        .optional()
        .describe("Notification severity: alert, notice, or warning"),
      destination_group: z
        .string()
        .optional()
        .describe("Group UUID to send notifications to"),
      destination_event_user: z
        .boolean()
        .optional()
        .describe("Also send to the user that triggered the event"),
    },
    handler: async (args) => {
      const result = await client.eventsApi.eventsRulesCreate({
        notificationRuleRequest: {
          ...
          destinationEventUser: args.destination_event_user as
            | boolean
            | undefined,
        },
      });
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      transports: z
        .array(z.string())
        .optional()
        .describe("New transport UUIDs"),
      severity: z.string().optional().describe("New severity"),
      destination_group: z
        .string()
        .optional()
        .describe("New destination group UUID"),
      destination_event_user: z
        .boolean()
        .optional()
        .describe("Send to triggering user"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      mode: z
        .string()
        .optional()
        .describe("Filter by mode (email, webhook, webhook_slack, local)"),
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      mode: z
        .string()
        .optional()
        .describe("Transport mode: email, webhook, webhook_slack, or local"),
      webhook_url: z
        .string()
        .optional()
        .describe("Webhook URL (for webhook/webhook_slack modes)"),
      webhook_mapping_body: z
        .string()
        .optional()
        .describe("Webhook body mapping UUID"),
      webhook_mapping_headers: z
        .string()
        .optional()
        .describe("Webhook headers mapping UUID"),
    ...
    handler: async (args) => {
      const result = await client.eventsApi.eventsTransportsCreate({
        notificationTransportRequest: {
          ...
          webhookMappingHeaders: args.webhook_mapping_headers as
            | string
            | undefined,
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      webhook_mapping_body: z
        .string()
        .optional()
        .describe("New webhook body mapping UUID"),
      webhook_mapping_headers: z
        .string()
        .optional()
        .describe("New webhook headers mapping UUID"),
      send_once: z.boolean().optional().describe("Only send notification once"),
    },
    handler: async (args) => {
  ...
  registerTool(server, config, {
    ...
    inputSchema: {
      ...
      search: z
        .string()
        .optional()
        .describe("Search across notification fields"),
      ordering: z.string().optional().describe("Field to order by"),
      page: z.number().optional().describe("Page number"),
      page_size: z.number().optional().describe("Number of results per page"),
    },
  ...
  registerTool(server, config, {
    ...
    description:
      "Update a notification, typically to mark it as seen or unseen.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
  ...
  registerTool(server, config, {
    ...
    description:
      "Delete a notification by its UUID. This action is irreversible.",
    accessTier: "full",
    annotations: {
      readOnlyHint: false,
      destructiveHint: true,
